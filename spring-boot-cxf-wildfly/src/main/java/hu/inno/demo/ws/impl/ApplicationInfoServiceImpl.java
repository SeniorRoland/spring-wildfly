...
@WebService(name = "ApplicationInfoService", serviceName = "ApplicationInfoService", portName = "ApplicationInfoServicePort", endpointInterface = "hu.inno.demo.ws.api.ApplicationInfoService", targetNamespace = "http://fair.nebih.gov.hu/")
public class ApplicationInfoServiceImpl implements ApplicationInfoService {
	@SuppressWarnings("unused")
	private static final org.slf4j.Logger logger = LoggerFactory.getLogger(ApplicationInfoServiceImpl.class);

	@Autowired
	private VersionInfo versionInfo;

	public ApplicationInfoResultContainer getApplicationInfo(CallContext callContext,
			ApplicationInfoRequest appInfoRequest) {
